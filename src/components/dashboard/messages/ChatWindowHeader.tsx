...
export function ChatWindowHeader({ thread }: ChatWindowHeaderProps) {
  return (
    <div className="flex items-center justify-between p-4 border-b border-[#333333] bg-[#1f1f1f]">
      {/* Client Profile Info */}
      <div className="flex items-center gap-3">
        ...
        <div className="space-y-0.5">
          <h4 className="text-sm font-bold text-white tracking-tight">{thread.clientName}</h4>
          <span className="text-[11px] font-normal text-slate-400 block leading-none">
      ...
      <div className="flex items-center gap-1 text-slate-400">
        <button
          className="p-2 rounded-xl hover:bg-[#2a2a2a] hover:text-white transition-colors cursor-pointer"
          title="Phone Call"
        >
