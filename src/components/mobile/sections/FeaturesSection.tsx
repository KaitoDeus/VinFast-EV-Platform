...
export function FeaturesSection() {
  ...
  return (
    <section id="features" className="relative scroll-mt-[64px] pt-12 pb-0 theme-bg overflow-hidden transition-colors duration-300">
...
export { FeaturesSection as MobileFeaturesSection };
