...
export function OrderSection() {
  ...
  return (
    <section id="preorder" className="scroll-mt-[64px] w-full bg-[#eeeeee] dark:bg-slate-950 transition-colors duration-300">
...
export { OrderSection as MobileOrderSection };
