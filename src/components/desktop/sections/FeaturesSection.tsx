...
export function FeaturesSection() {
  ...
  return (
    <section id="features" className="relative scroll-mt-[80px] pt-16 pb-0 theme-bg overflow-hidden transition-colors duration-300">
...
export { FeaturesSection as DesktopFeaturesSection };
