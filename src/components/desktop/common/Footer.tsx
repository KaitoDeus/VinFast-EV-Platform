      ...
      <div className="relative z-10 max-w-[1240px] mx-auto text-center space-y-6">
          ...
          <div className="bg-[#4a4e63]/60 backdrop-blur-md rounded-sm px-8 py-3.5 text-[16px] text-slate-200 font-normal inline-flex items-center gap-6 justify-center flex-wrap shadow-lg border border-slate-600/30">
            ...
            <span>
              ...
              <a
                ...
                className="hover:text-[#00a8ff] transition-colors font-medium"
              >
        ...
        <div className="flex items-center justify-center gap-6 pt-3 text-[16px]">
          ...
          <button
            ...
            className={`inline-flex items-center gap-2.5 transition-all cursor-pointer py-1 no-underline ${
              lang === "vi"
                ? "text-[#00a8ff] font-bold"
                : "text-slate-400 font-normal hover:text-white"
            }`}
          >
            <svg className="w-6 h-4 rounded-[2px] shadow-sm shrink-0 overflow-hidden" viewBox="0 0 30 20">
        ...
        {/* Copyright Subtext */}
        <p className="text-[16px] text-slate-400 font-normal pt-2">
          {t("footer.copyright")}
        </p>
      </div>
    </footer>
...
export { Footer as DesktopFooter };
